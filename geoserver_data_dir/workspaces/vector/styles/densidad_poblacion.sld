...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:se="http://www.opengis.net/se" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1.0" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <NamedLayer>
    <se:Name>T013_Population density</se:Name>
    <UserStyle>
      <se:Name>T013_Population density</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>0 a 4,9</se:Name>
          <se:Description>
            <se:Title>0 a 4,9</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>Densi_hac</ogc:PropertyName>
              <ogc:Literal>0 a 4,9</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
        ...
        <se:Rule>
          <se:Name>10 a 29,9</se:Name>
          <se:Description>
            <se:Title>10 a 29,9</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>Densi_hac</ogc:PropertyName>
              <ogc:Literal>10 a 29,9</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
        ...
        <se:Rule>
          <se:Name>30 a 49,9</se:Name>
          <se:Description>
            <se:Title>30 a 49,9</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>Densi_hac</ogc:PropertyName>
              <ogc:Literal>30 a 49,9</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
        ...
        <se:Rule>
          <se:Name>5 a 9,9</se:Name>
          <se:Description>
            <se:Title>5 a 9,9</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>Densi_hac</ogc:PropertyName>
              <ogc:Literal>5 a 9,9</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
        ...
        <se:Rule>
          <se:Name>Más 50</se:Name>
          <se:Description>
            <se:Title>Más 50</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>Densi_hac</ogc:PropertyName>
              <ogc:Literal>Más 50</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
